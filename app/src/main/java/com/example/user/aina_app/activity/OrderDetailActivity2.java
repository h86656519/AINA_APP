...
public class OrderDetailActivity2 extends AppCompatActivity {
    private final String TAG = "OrderDetailActivity12";
    int count;
    String productName, productPrice;
    ProductExpandableListAdapter2 listAdapter;
    ExpandableListView expListView;
    List<String> listDataHeader;
    HashMap<String, ArrayList<Good>> listDataChild;
...
//    private ArrayList<Integer> productQuantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //接資料
        goods = (ArrayList<Good>) getIntent().getSerializableExtra("goods");
        Log.i(TAG, "objectList.sizeee" + goods.size());
        ...
        listAdapter = new ProductExpandableListAdapter2(context, goods, listDataHeader);
...
//        listDataChild = new HashMap<String, List<String>>();
        listDataChild = new HashMap<String, ArrayList<Good>>();

        // Adding child data
        listDataHeader.add("商品詳情");

        // Adding child data
        listDataChild.put(listDataHeader.get(0), goods); // Header, Child data
    ...
    private void setListViewHeight(ExpandableListView listView, int group) {
        ProductExpandableListAdapter2 listAdapter = (ProductExpandableListAdapter2) listView.getExpandableListAdapter();
        int totalHeight = 0;
