package com.example.user.aina_app.layout;
...
public class CustomRoundAngleImageView extends AppCompatImageView {
    ...
    public CustomRoundAngleImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public CustomRoundAngleImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderRadius = ta.getInteger(R.styleable.MyImageViewRatio_angle, 360);
