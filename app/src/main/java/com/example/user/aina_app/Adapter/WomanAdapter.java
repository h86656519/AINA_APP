...
public class WomanAdapter extends RecyclerView.Adapter<WomanAdapter.ViewHolder> {
    ...
    private final String TAG = "WomanAdapter";
    Context mContext;
    public WomanAdapter(ArrayList<String> productname) {
        this.productname = productname;

    }

    @Override
    public WomanAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(WomanAdapter.ViewHolder holder, final int position) {
